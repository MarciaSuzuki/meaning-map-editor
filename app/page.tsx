          ...
          <div>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              {NON_PREFILL_SECTIONS.map((section) => (
                <div key={section.title} style={{ borderRadius: 12, border: `1px solid ${s.border}`, padding: '1rem', backgroundColor: '#FBFAF3' }}>
                  <h4 style={{ fontFamily: s.display, fontSize: '0.9rem', fontWeight: 600, margin: '0 0 0.6rem 0' }}>{section.title}</h4>
